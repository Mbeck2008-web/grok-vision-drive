...
| File | What | How |
| --- | --- | --- |
| `gvd_cabin_synthetic.png` | GVD VISION clean cabin, chase 3/4, parked (`engaged=false`, title **OFF**, no ice underglow) | `python.viz.stage.smoke` (`scripts/render_readme_media.py`) |
