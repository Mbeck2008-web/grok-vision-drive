...
| File | What | How |
| --- | --- | --- |
| `gvd_cabin_synthetic.png` | GVD VISION clean cabin, chase 3/4, parked (`engaged=false`, title **OFF**, no ice underglow). Agent boxes are empty solids (LEAD / BRAKE, no center disc) | `python.viz.stage.smoke` (`scripts/render_readme_media.py`) |
